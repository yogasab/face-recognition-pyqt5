...
class Ui_OutputDialog(QDialog):
    ...
    def face_rec_(self, frame):
        ...
        # self.recognizer = cv2.face.LBPHFaceRecognizer_create().read('trainner')
        ...
        for (x, y, w, h) in faces:
            ...
            format_picture = 'images.png'
            cv2.imwrite(format_picture, roi_color)
            # Draw rectangle on iterated images
            color = (0,255,0)
            stroke = 2
            end_cord_x = x+w
            end_cord_y = y+h
